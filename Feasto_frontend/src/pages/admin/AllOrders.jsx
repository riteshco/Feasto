                        ...
                        <div className="w-1/2">
                            <CardContent className="flex flex-col gap-4 items-center justify-center my-12 py-0">
                                ...
                                <div className="w-3/4 flex justify-center">
                                    <Button onClick={()=>{AskToAcceptOrder(order.id)}} className="w-1/2">Accept and Generate Bill!</Button>
                                </div>
                                    :
                                <div className="w-3/4 flex justify-center" >
                                    <Button variant="outline" >Order has been accepted/verified by Admin!</Button>
                                </div>}
                            </CardContent>
                        </div>
                    </Card>
